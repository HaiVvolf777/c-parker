  ...
  return (
    <div className="mt-[100px] md:mt-[150px] relative">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className=" w-full md:w-[70%] xl:w-[60%] 2xl:w-[50%] mx-auto border-2 border-gray-200 dark:border-[#141429] rounded-[10px] bg-white dark:bg-[#0B0B1A4D] backdrop-blur-[100px] px-[24px] md:px-[100px] py-[40px] md:py-[54px] relative overflow-hidden animate-fade-in-up hover:scale-105 transition-all duration-500">
          <h2 className="text-white font-bold text-[28px] md:text-[40px] text-center animate-fade-in-up">The Parker Pool</h2>
          <p className="text-white text-[16px] md:text-[26px] mt-5 text-center animate-fade-in-up animation-delay-200">Already <span className="text-[#7D40FF] animate-pulse-slow">4,405,726</span> Carbon Credit Tokens pooled in — growing every second.</p>
          <div className="relative flex justify-center items-center mt-8 animate-fade-in-up animation-delay-400">
            ...
            <span className="absolute text-[20px] md:text-[30px] text-white keep-white font-bold text-center top-1/4 left-1/2 -translate-x-1/2 translate-y-[80px] animate-count-up">4,405,726</span>
          </div>
