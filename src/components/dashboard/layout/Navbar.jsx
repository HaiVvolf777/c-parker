          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col items-end gap-1">
              <button
                ...
                className="bg-[#6F23D5] hover:bg-[#5a1fb8] text-white text-[16px] font-semibold rounded-[12px] px-4 py-2 transition-all disabled:opacity-60 disabled:cursor-not-allowed"
