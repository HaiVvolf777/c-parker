    ...
    <div className={`mt-[60px] min-w-[700px] text-[#0a0a0a] dark:text-white ${className}`}>
      ...
      <div className="border-2 border-[#E5E7EB] dark:border-[#141429] rounded-[10px] bg-white/60 dark:bg-[#0B0B1A4D] backdrop-blur-[30px] px-[44px]">
        <table className="w-full">
          <thead>
            <tr
              className={`*:pt-[44px] *:pb-[30px] border-b-[1px] border-[#E5E7EB] dark:border-[#141429] px-[42px] *:font-[400] ${isDashboard ? '*:text-[18px]' : '*:text-[20px]'
          ...
          <tbody>
            ...
            {activityData.map((item) => (
              <tr
                ...
                className={`*:py-[30px] *px-4 border-b-[1px] border-[#E5E7EB] dark:border-[#141429] text-center ${isDashboard ? '*:text-[16px]' : '*:text-[20px]'
              ...
              >
                <td>
                  ...
                  >
                    <rect x="0.5" y="0.078125" width="59" height="59" rx="29.5" className="fill-[#7D40FF1A] dark:fill-[#01F1E31A]" />
                    <path
                      ...
                      className="fill-[#7D40FF] dark:fill-[#01F1E3]"
                    />
                    <path
                ...
                <td>
                  <span className="relative inline-block rounded-md p-[1px]">
                    ...
                    <span
                      className={`relative block rounded-md px-4 py-2 font-semibold ${isDashboard ? 'text-[16px]' : 'text-[20px]'
                  ...
                  {item.transactionHash ? (
                    ...
                    >
                      <svg width="20" height="20" viewBox="0 0 32 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M29.2356 21.3235V15.3529C29.2356 14.3293 28.5048 13.647 27.4084 13.647C26.3121 13.647 25.5812 14.3293 25.5812 15.3529V21.3235C25.5812 23.7117 23.5712 25.5882 21.0131 25.5882H8.22253C5.66441 25.5882 3.65446 23.7117 3.65446 21.3235V9.38228C3.65446 6.99405 5.66441 5.11758 8.22253 5.11758H14.6178C15.7142 5.11758 16.4451 4.43522 16.4451 3.41169C16.4451 2.38816 15.7142 1.70581 14.6178 1.70581H8.22253C3.65446 1.70581 0 5.11758 0 9.38228V21.3235C0 25.5882 3.65446 28.9999 8.22253 28.9999H21.0131C25.5812 28.9999 29.2356 25.5882 29.2356 21.3235Z"  className="fill-[#747474] dark:fill-[#ffffff]" />
                        <path d="M31.0628 10.2353V1.70588C31.0628 1.53529 31.0628 1.19412 30.8801 1.02353C30.6974 0.682353 30.3319 0.341176 29.9665 0.170588C29.7837 -1.65228e-07 29.4183 0 29.2356 0H20.4649C19.3685 0 18.6377 0.682353 18.6377 1.70588C18.6377 2.72941 19.3685 3.41176 20.4649 3.41176H24.8502L13.3387 14.1588C12.6078 14.8412 12.6078 15.8647 13.3387 16.5471C13.7041 16.8882 14.2523 17.0588 14.6178 17.0588C14.9832 17.0588 15.5314 16.8882 15.8968 16.5471L27.4083 5.8V10.2353C27.4083 11.2588 28.1392 11.9412 29.2356 11.9412C30.3319 11.9412 31.0628 11.2588 31.0628 10.2353Z"      className="fill-[#747474] dark:fill-[#ffffff]" />
                      </svg>
                    </a>
                  ) : (
