  ...
  return (
    <div className="bg-white/60 dark:bg-[#191932] rounded-[10px] p-[18px] mt-5 border-2 border-[#E5E7EB] dark:border-[#141429]">
      ...
      <div className="my-[10px]">
        ...
        <p className="text-[#EE9C04] dark:text-[#F0B90B] text-lg font-semibold mt-1">Received</p>
      </div>
      ...
      <div>
        ...
        <p className="text-[#EE9C04] dark:text-[#F0B90B] text-lg font-semibold mt-1">Missed</p>
      </div>
    </div>
  );
};
