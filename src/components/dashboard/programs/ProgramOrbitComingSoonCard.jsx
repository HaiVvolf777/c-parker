    ...
    <div className="w-full mt-[30px]">
      ...
      >
        ...
        <div className="relative z-10">
          <div className="">
            <p className="text-white text-[30px] font-bold">Orbit C</p>

            <p className="text-white font-semibold mt-[10px] mb-[30px]">
              Bigger rewards. Faster payouts. <br /> Next-level performance.
            </p>

            <div className="">
              <button className="text-white font-bold bg-gradient-to-r from-[#FF04B4] via-[#FF4000] to-[#F0B90B] border-[1px] border-[#FFD85B4D] px-[60px] py-3 rounded-[10px] cursor-pointer hover:opacity-90 transition-opacity">
                Coming Soon
              </button>
            </div>
          </div>
