...
const NodeLevelProgression = () => {
  ...
  useEffect(() => {
    const fetchCycles = async () => {
      ...
      setIsLoading(true);
      try {
        const data = await getLevelCycles(userId, 'ORBIT_A', level);
                        ...
                        <div className="flex flex-col gap-0">
                          ...
                          <div className="w-full overflow-hidden">
                            {isLoading ? (
                              ...
                              <SliderLevelNode className="w-full" stage={slideIndex} cycleData={currentCycle} showLocked={true} level={level} userId={userId} />
                            )}
                          </div>
                        </div>
